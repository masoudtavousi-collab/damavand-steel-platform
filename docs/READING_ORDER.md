...
13. [PD-02B Minimum Canonical Slice Scope v1.0](PD02B_MINIMUM_CANONICAL_SLICE_SCOPE_V1.0.md), treated as the active exact REVIEW authority and lifecycle/test/evidence boundary.
