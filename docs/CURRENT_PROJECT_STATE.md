...
C008-R1 is completed/archive-only when this document is present on `main`. No active Mission exists. No repository mutation or additional Merge is authorized. Preserve G1 `6/9 / NOT_READY`; supplier intake is deferred—not waived or verified—until a later exact authority, and the sole active Founder evidence input is rights-safe production media. C009, M4, every later P1 Mission, P2, P3, P4, and P5 remain `NOT STARTED`.
