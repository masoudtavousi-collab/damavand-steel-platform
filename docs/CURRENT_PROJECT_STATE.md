...
- **Current phase:** `PD-03A` Pilot Prerequisite Foundation — `DRAFT`
...
| `PD-03A` Pilot Prerequisite Foundation | `FD-PD03A-001`; [PD-03A Scope v1.0](PD03A_PILOT_PREREQUISITE_FOUNDATION_SCOPE_V1.0.md); starting SHA `dd4d4e9dde59ce652edb5b99d2df3e84b56b8031`; immutable extension; 46 dispatched mutation cases | `DRAFT`; first independent technical review returned REWORK and its five findings were corrected; exact-SHA re-review remains required; PD-02B aggregate registries/hashes remain unchanged; no canonical Pilot/Product/SKU/availability or runtime authority |
...
- PD-03A is a DRAFT prerequisite extension only. Until its legal lifecycle and
  Git gates complete, its records and Length/Metre/Millimetre promotion remain
  `CANDIDATE_UNVERIFIED`. Its synthetic tuples are test evidence, not Pilots.
...
Complete only the authorized PD-03A lifecycle and conditional Git cycle. Stop
unless independent technical review returns PASS and every local/CI, hash,
allowlist, conflict, and lifecycle gate succeeds.
