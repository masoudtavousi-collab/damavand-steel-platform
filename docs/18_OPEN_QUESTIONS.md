...
| OQ-GOV-023 | Which Product Repository hierarchy is canonical, and how do Parent/Variation commerce constructs relate to it? | `FD-W2G-001`, [Enterprise Product Data Model](19_PRODUCT_DATA_MODEL.md#product-hierarchy), and `FD-PD03A-001` | Partially resolved: canonical hierarchy and downstream Parent/Variation boundary are settled; PD-03A defines only the decorative Pipe Series and one internal Variant Rule identity/Profile prerequisite. Canonical Pilot combinations and broader Series/Variant Rules remain separately gated. |
