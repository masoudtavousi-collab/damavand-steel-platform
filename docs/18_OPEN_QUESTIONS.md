...
| OQ-DATA-011 | Which real Product Attribute definitions, Profiles, values, and controlled terms may enter the canonical registries? | `FD-PD02B-001` and [PD-02B Scope](PD02B_MINIMUM_CANONICAL_SLICE_SCOPE_V1.0.md) | Resolved only for the exact REVIEW minimum slice: Material, Grade, `stainless_steel`, `201`, `304`, `316`, and one INTERNAL Family Profile; all other data remains out of scope |
| OQ-DATA-012 | Which stable Catalog/Platform/Family scope identity, terminology, Product Data owner, and qualified reviewers are approved for the minimum canonical Profile? | `FD-PD02B-001`, Material/Grade human reviews, and [PD-02B Scope](PD02B_MINIMUM_CANONICAL_SLICE_SCOPE_V1.0.md) | Resolved for PD-02B exact scope; independent technical review and final Founder lifecycle approval remain open gates |
| OQ-DATA-013 | Has PD-02B received final Founder approval after independent technical PASS? | `PD02B-TECH-REVIEW-001` and future `FD-PD02B-001` transition evidence | Partially resolved: technical attempt 2 PASS and DRAFT → REVIEW are recorded; final Founder approval still blocks APPROVED and merge |
