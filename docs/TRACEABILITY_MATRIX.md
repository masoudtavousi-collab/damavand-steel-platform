...
| `POST12-MAIN` | PR #13, PR #14, PR #12, and PR #15–#27 integration history | GitHub merge evidence and [Current Project State](CURRENT_PROJECT_STATE.md) | Records the actual order: recovery consolidation, post-recovery state, BP2 hardening, governance reconciliation, BP1 M1 hardening, post-PR16 reconciliation, BP2 lifecycle approval, post-PR18 reconciliation, `GOV-XD-00`, PD-01, PD-02A, PD-02B, PD-03A, PD-03B, post-PD-03B state reconciliation, then DS program directive integration | Repository evidence only |
...
| `C1-T06-LOCAL` | Review/legacy canonical-owner reconciliation candidate | Founder Gate 1 authorization plus explicit first and second Scope Amendments dated 2026-08-03; exact starting SHA `c4dbd8d1713a27e2e5185ceee9e64177ff28f7fa` from merged PR #28 and successful main CI `30766701675`; `FD-W2G-001`; `FD-W2G-002`; exact amended 39-path allowlist | Candidate local patch reclassifies in-scope Product Family/Group/Type, Variable Parent, Variation, attributes/values/axes, component facts, page, URL, SEO, Schema.org, and WooCommerce ownership language as canonical Repository source, explicit downstream mapping, or preserved non-governing history; retains `Catalog → Platform → Family → Series → Variant Rules → SKU` as the only canonical Repository hierarchy; completion remains subject to fixed-hash independent review | Local Review-state documentation correction in progress; this row is not a PASS/completion claim, and no Product/SKU/fact/object/runtime creation, lifecycle promotion, stage, commit, push, PR, merge, or branch deletion is authorized |
