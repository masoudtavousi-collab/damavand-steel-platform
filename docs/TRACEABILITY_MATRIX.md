...
> Project OS 2.0: C008 and C008-R1 preserve G1 `6/9 / NOT_READY`; C008-FT1 remains a separate `FALSE / 4 of 12` launch gate. C009 promotes only one exact internal combination/SKU leaf from `pilot:f5922666261e`; it creates no Availability, commercial, Runtime, gate-re-evaluation, M4 or successor authority.
