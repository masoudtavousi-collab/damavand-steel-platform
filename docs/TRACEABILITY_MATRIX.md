...
| `C004-ADVANTAGE-BLUEPRINT` | [Advantage Specification](DAMAVAND_COMPETITIVE_ADVANTAGE_SPECIFICATION_V1.0.md), [Anti-Pattern Register](DAMAVAND_COMPETITIVE_ANTI_PATTERN_REGISTER_V1.0.md), [201/51 Blueprint](201_51_PILOT_COMPETITIVE_EXPERIENCE_BLUEPRINT_V1.0.md), machine advantage registry | External observations, canonical C003 Founder evidence, C004 architecture proposals, Product/Variant/C002/Search/SEO/Commerce owner references | Separates ten original advantages into `6 USE_NOW / 3 PLAN_NOW_IMPLEMENT_LATER / 1 NEEDS_FOUNDER_DECISION`, records 12 prevention rules and a Mobile RTL/SEO blueprint | Status is planning-only; C002 stays `0/9`, commerce `INQUIRY_ONLY`, no Product/commerce/runtime implementation |
