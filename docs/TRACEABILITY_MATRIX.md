...
| `PD03A-DATA` | PD-03A prerequisite Contract/Schema/extension registry/validator | Founder Series, naming, axis, Unit, precision, and no-claim decisions | Exact 2 entities, 4 Attributes, 1 Finish Registry/Term, 1 six-rule INTERNAL Series Profile, and 11 labels | REVIEW records remain Candidate; PD-02B aggregate registries remain immutable |
...
| `PD03A-EVIDENCE` | Dedicated approval Contract/Schema/registry/validator | Founder authorization; failed-review history; independent technical PASS | Four dataset hashes plus reviewed Commit-object, CI and verdict-artifact bindings; no false human PASS; anti-replay and lifecycle checks | Approval remains Candidate in REVIEW |
...
| `PD03A-REVIEW` | `PD03A-TECH-REVIEW-001` attempts 1–3; reviewed SHA `cb6c817116d0e97e2d217fe2402d85ff4b96f53a`; CI `30696083295` | Independent read-only technical review and exact-scope correction cycles | Attempts 1–2 `REWORK`; attempt 3 `PASS` with zero findings; legal `DRAFT → REVIEW` recorded | Founder `REVIEW → APPROVED`, REVIEW-stage CI, and conditional Git gates remain required |
