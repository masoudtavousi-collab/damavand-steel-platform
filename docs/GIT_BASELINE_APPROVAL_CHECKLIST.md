...
## Current Applicability — 2026-07-19
...
Current Git authority comes only from the explicit 2026-07-19 Class B Wave 1 Founder authorization: exactly 19 approved paths, one scoped commit, push of only `codex/class-b-wave-01-governance`, and one Draft PR. PR #1, the six Sprint 1 reports, all Waves 2–10 paths, merge, runtime, WordPress, product, content, publication, deployment, and production remain excluded.
