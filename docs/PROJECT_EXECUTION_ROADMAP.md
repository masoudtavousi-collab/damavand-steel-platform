...
4. `PD-02B` — minimum canonical Catalog/Platform/Family scope, Material/Grade definitions, four controlled terms, INTERNAL Profile, 18 labels, and Approval Evidence. **`DRAFT` under `FD-PD02B-001`; technical review and Founder approval remain gated.**
