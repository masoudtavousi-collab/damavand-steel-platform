...
| `C008 — C002 Readiness / Real-world Evidence Closure` | Independently review six C005-ready criteria, close or explicitly preserve Supply/Fulfillment/Media gaps, classify all nine criteria and produce the [G1 review packet](C008_C002_READINESS_EVIDENCE_REVIEW_PACKET_V1.0.md) | [C008 Scope](C008_C002_READINESS_REAL_WORLD_EVIDENCE_CLOSURE_SCOPE_V1.0.md) and [machine registry](../repository/data/registries/extensions/c008/201-51-readiness-evidence-closure.yaml); outcome `4/9 / NOT_READY`, candidate count `0`, five blockers, `FOUNDER_SELECTION_READY=FALSE`, no M4 candidate or authority |
