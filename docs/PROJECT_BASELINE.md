...
| PD-03B Canonical Pilot Records | `DRAFT` under `FD-PD03B-001`; exact three stable repository Pilot records only, with historical references non-identifying, Availability `MISSING_DATA_VALUE`, and Golden/Import/Runtime readiness false; independent technical review and lifecycle approval remain pending |
