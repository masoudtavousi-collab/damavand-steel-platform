...
| PD-02A Controlled Values and Attribute Profiles | DRAFT synthetic foundation; canonical population disabled | `FD-PD02A-001`; exact 38 paths; separate closed value-registry and Profile contracts/schemas; offline validators; synthetic fixtures; positive/negative/adversarial tests | All three canonical collections must remain empty; stable Family scope, real terminology, assigned data/domain roles, and PD-02B approval remain missing |
