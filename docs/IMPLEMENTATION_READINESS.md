...
| PD-03B Canonical Pilot Records | DRAFT; repository-only | `FD-PD03B-001`; [PD-03B Scope](PD03B_CANONICAL_PILOT_SCOPE_V1.0.md); exact three stable Pilot identities; 33-path boundary; 43 dispatched mutations required | Independent technical PASS and legal lifecycle are pending; Availability is missing and all readiness flags are false; no Product/SKU, Master/Golden, import, or runtime authority |
