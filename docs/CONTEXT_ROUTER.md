...
| Product Data / taxonomy | [Enterprise Product Data Model](19_PRODUCT_DATA_MODEL.md), relevant contracts/schemas/registries under `repository/data/`, and only the applicable approved PD scope |
